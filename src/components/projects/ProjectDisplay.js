...
import { Sidebar, Segment, Header, Button, Icon } from 'semantic-ui-react'

class ProjectDisplay extends Component {
  render() {
    return (
      <Sidebar inverted as={Segment}  direction='right' animation='slide along' width='wide' visible={this.props.visible} icon='labeled' vertical>
